        ...
        <div class="card my-3 w-100" style=" background-color: #F3F3F3;">
            ...
            <div class="title ">
                <a  class = "d-flex justify-content-center" href="/#">
                    <h2 class=" fs-6 align-item-center mb-0 p-2" style="color: #d36e24; text-overflow: ellipsis;overflow: hidden; white-space: nowrap;">${listOfTours[i]['tours'][j]['title']}</h2>
                </a>
            </div>
            <!-- img of card -->
            <a  href="/#">
            ...
            <div class="d-flex justify-content-between collapse py-2 Card__Text">
                ...
                <span  class= " text-nowrap p-1 border border-secondary "style="text-overflow: clip;  overflow: hidden; font-size: 14px;">${listOfTours[i]['tours'][j]['name']}</span>
                <hr class="flex-fill" style="width:9%">
            </div>
            <!-- information -->
